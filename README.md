# KinCartaTest
Project designed for the automation of the website [amazon](amazon.com)
...
Git:
    ...
    Whit SSH
    git clone git@github.com:DiegoZaraza/KinCartaTest.git
    cd KinCartaTest
    
    With HTTPS
    git clone https://github.com/DiegoZaraza/KinCartaTest.git
    cd KinCartaTest
    
Or simply [download a zip](https://github.com/DiegoZaraza/KinCartaTest/archive/refs/heads/main.zip) file
